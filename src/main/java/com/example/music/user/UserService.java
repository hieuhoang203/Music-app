    ...
    * */
    ...
    public Map<Object, Object> verifyUser(Byte type, UserDto dto) {
        ...
        try {
            ...
            if (dto.getEmail().isEmpty() || accountRepository.existsByLogin(dto.getEmail())) {
        ...
        try {
            ...
            if (user.isPresent()) {
                UserDto dto = UserDto.builder()
                        ...
                        .role(user.get().getAccount().getRole())
                        .build();
...
//            javaMailService.sendPassWord(dto.getEmail(), "User creation successful!", random.toString(), dto.getName());
    ...
    public Map<Object, Object> getNewUserOrArtis(String role) {
        ...
        Result result = Result.OK();
        try {
            Map<Integer, UserResponse> userMap = this.userRepository.getNewUserOrArtis(role).stream().collect(Collectors.toMap(UserResponse::getId, Function.identity()));
    ...
    public Map<Object, Object> getArtisForSelect() {
        ...
        Result result = Result.OK();
        try {
            List<ArtisCombobox> data = this.userRepository.getArtisForSelect();
            finalResult.put(Constant.RESPONSE_KEY.DATA, data);
        } catch (Exception e) {
